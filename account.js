...
let isDarkThemeActivated = false;
...
function viewDashboard() {
    ...
    const charts = [document.getElementById("chart1"), document.getElementById("chart2"), document.getElementById("chart3"), document.getElementById("chart4")];
    ...
    const chartTypes = ["pie", "polarArea", "line", "bar"];
...
const drawChart = (type, canvasName) => {
    ...
    return new Chart(canvasName, {
        type,
        data: { labels: xs, datasets: [{ label: 'Expenses', data: ys, borderWidth: 1 }] },
...
function saveData() {
    ...
    // No need to save totalExpenses and currentBalance
